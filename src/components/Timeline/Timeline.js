        ...
        <div className="timeline-content right-content">
          ...
          <div className="text-box">
            ...
            <p>
              <ul>
                <li>
                  Active participation in various hackathons, showcasing
                  problem-solving skills and collaborative spirit.
                </li>
                <li>
                  Dedicated learning journey, completing courses on NPTEL,
                  Coursera, Udemy, and Jobaaj to broaden skillsets.
                </li>
                <li>
